...
public class ArrCharOps {
    ...
    public static boolean equals(char[] arr1, char[] arr2) {
        //In order to ensure the function works with the edge case that arr2 is bigger than arr1 but arr1 is identical to the beginning of arr2, we first check if the two arrays are the same length.
